        ...
        <div className="products-section products-lists-section">
          <div className="products-section-text">
            ...
            <p className="products-subtitle">
              ...
              Our extensive range of high-quality marine and industrial
              products is designed to meet your every need. From cutting-edge
              equipment to dependable spare parts, we provide the tools to fuel your
              success and keep your operations running smoothly.
            </p>
          </div>
